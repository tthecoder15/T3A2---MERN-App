...
const ServicesButtons = () => {
    ...
    const handleButtonClick = (serviceName, text) => {
    ...
    return (
        <div className="services-container">
            <div className="buttons-column">
                <button onClick={() => handleButtonClick('Check-Ups',
                    <>
                        <h2>Check-Ups</h2>
                        <p>
                    ...
                    {activeService === 'Check-Ups' ? 'Close' : 'Check-Ups'}
                </button>

                <button onClick={() => handleButtonClick('Dental Service',
                    <>
                        <h2>Dental Service</h2>
                        <p>
                            Dental health is an often-overlooked aspect of pet care, but it’s crucial for their overall well-being. 
                    ...
                    {activeService === 'Dental Service' ? 'Close' : 'Dental Service'}
                </button>

                <button onClick={() => handleButtonClick('Vaccinations',
                    <>
                        <h2>Vaccinations</h2>
                        <p>
                            Vaccinations are a vital part of preventive care for your pet. 
                    ...
                    {activeService === 'Vaccinations' ? 'Close' : 'Vaccinations'}
                </button>

                <button onClick={() => handleButtonClick('Surgeries',
                    <>
                        <h2>Surgeries</h2>
                        <p>
                            Surgery is sometimes necessary to address health issues in pets. 
                    ...
                    {activeService === 'Surgeries' ? 'Close' : 'Surgeries'}
                </button>
            </div>
